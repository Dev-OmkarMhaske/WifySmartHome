...
public class ScheduleAccessoriesAdapter extends RecyclerView.Adapter<ScheduleAccessoriesAdapter.RecyclerViewHolder> {

    private final Context context;

    private LinkedList<Object> accessories;

    public ScheduleAccessoriesAdapter(Context context, LinkedList<Object> accessories) {
            ...
            if (object instanceof GenericObject) {
                ...
                if (genericObject.getDmData().length() > 1 && !genericObject.getDmData().equalsIgnoreCase("-")) {
                    ...
                    holder.generic_setting.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            new CustomPopups().showPopupWindowForGeneric(view, genericObject, UtilityConstants.SCHEDULE);
                        }
                    });
                }
                ...
                holder.rgb_tile_background.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        ...
                        i.putExtra(UtilityConstants.FROM, UtilityConstants.SCHEDULE);
                ...
                holder.curtain_tile_background.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        ...
                        new CustomPopups().showPopupWindowForCurtain(view, curtainObject, UtilityConstants.SCHEDULE);
                ...
                holder.fan_tile_background.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        ...
                        new CustomPopups().showPopupWindowForFan(view, fanObject, UtilityConstants.SCHEDULE);
    ...
    public void setFanSpeedLevel(String fanSpeedLevel, ScheduleAccessoriesAdapter.RecyclerViewHolder holder) {
    ...
    static class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout power_tile_background, generic_tile_background, rgb_tile_background, fan_tile_background, fan_speed_layout, curtain_tile_background;

        TextView generic_title, rgb_title, fan_title, curtain_title, power_title;

        ImageView fan_logo, curtain_logo, rgb_logo, curtain_setting, rgb_setting, fan_setting, generic_setting, generic_logo, power_logo;

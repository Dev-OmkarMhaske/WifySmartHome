...
public class MotionSceneAdapter extends RecyclerView.Adapter<MotionSceneAdapter.RecyclerViewHolder> {

    private final Context context;
    private List<SceneObject> scenes;

    public MotionSceneAdapter(Context context, List<SceneObject> scenes) {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, final int i) {
        ...
        try {
            ...
            holder.scene_check.setChecked(EditMotionActivity.motionObject.getScene_ids().contains(sceneObject.getFile()));
            ...
            holder.scene_check.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    if (holder.scene_check.isChecked()) {
                        ...
                        EditMotionActivity.updateMotionSceneData(sceneObject.getFile(),  UtilityConstants.ADD);

                    } else {

                        EditMotionActivity.updateMotionSceneData(sceneObject.getFile(), UtilityConstants.DELETE);
